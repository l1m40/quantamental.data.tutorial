...
Uma das métricas vitais da nossa telemetria é a **densidade de cobertura dos balanços**. Como cada empresa listada deve, obrigatoriamente, publicar um relatório a cada trimestre, monitoramos a "pulsação" desses dados ao longo do tempo. Lacunas nesse mapa podem indicar desde atrasos na divulgação pela empresa até falhas no nosso processo de extração (scraping).

O gráfico abaixo apresenta a matriz de disponibilidade de relatórios. Cada linha representa uma empresa e cada coluna um trimestre fiscal. O preenchimento indica que o dado foi capturado e integrado com sucesso à ontologia.
